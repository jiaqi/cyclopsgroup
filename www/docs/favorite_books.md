...
Even on fundamental topics, such as functionality versus maintainability, or what 'architecture' truly means, debates recur constantly between engineers and engineers, technical leads and managers, CTOs and executives. The hidden costs of neglecting this book are immeasurable. Below is a powerful passage about the role of architect that I personally have cited in countless occasions to dispel a common misunderstanding held by many professionals.
